...
export default class GameData {
    static allFoodData: { [key: string]: FoodData } = {
        'rice': new FoodData(350, 250, "饭", '1', '1', 10, 10),
        'nori': new FoodData(350, 150, "海苔", '2', '2', 10, 10),
        'ikura': new FoodData(350, 50, "鲑鱼子", '3', '3', 10, 10),

        '4': new FoodData(250, 250, "鲑鱼", '4', '4', 10, 10),
        '5': new FoodData(250, 150, "5", '5', '5', 10, 10),
        'kappa': new FoodData(250, 50, "黄瓜", '6', '6', 10, 10),

        '7': new FoodData(150, 250, "扁口鱼", '7', '7', 10, 10),
        'saba': new FoodData(150, 150, "鯖鱼", '8', '8', 10, 10),
        'tako': new FoodData(150, 50, "章鱼", '9', '9', 10, 10),

        'hamachi': new FoodData(50, 250, "鰤鱼", '10', '10', 10, 10),
        'tai': new FoodData(50, 150, "鲷鱼", '11', '11', 10, 10),
        'anago': new FoodData(50, 50, "鳗鱼", '12', '12', 10, 10),
        'ebi': new FoodData(450, 250, "虾", "13", '13', 10, 10),
    ...
    static allRecipeData: { [key: number]: RecipeData } = {
        '1': new RecipeData('海苔饭团', '2饭+1苔', '01', ['1', '1', '2'], ['01', '01', '01']),
    ...
    static guankaData: { [key: number]: GuankaData } = {
        1: new GuankaData(300, [
            GameData.allFoodData['rice'],
            GameData.allFoodData['nori'],
            GameData.allFoodData['ikura'],
        ], [
